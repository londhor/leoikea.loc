"use strict";
var OurClientsIndexDataTable = function() {
    ...
    var initAction = function () {
        $('#OurClientsTableReset').on('click', function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <a href="/our-clients/update?id=` + full.Id + `" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Редагувати">
                            ...
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="/our-clients/update?id=` + full.Id + `"><i class="la la-edit"></i> Редагувати</a>
                                    <a class="dropdown-item" data-method="post" data-confirm="Ви впевнені що хочете видалити цей елемент?" href="/our-clients/delete?id=` + full.Id + `"><i class="la la-user-times"></i> Видалити</a>
                                </div>
                            </span>`;
                    },
