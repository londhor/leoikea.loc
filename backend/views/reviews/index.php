...
\metronic\Metronic::registerJsFile($this, 'assets/snippets/pages/reviews/index.js');
...
<div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet__body">
        ...
        <div class="m_datatable">
            <table class="table table-striped- table-bordered table-hover table-checkable" id="ReviewsIndexTable">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Зображення</th>
