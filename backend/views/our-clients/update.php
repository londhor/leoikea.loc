...
/* @var $model \common\models\OurClients|null */
/* @var $form ActiveForm */
...
$this->params['headTitle'] = 'Нам довіряють - ' . ($model->isNewRecord ? 'Новий запис' : 'Редагування');

$this->params['breadcrumbs'] = [
    ['label' => 'Контент блоки'],
    ['label' => 'Нам довіряють', 'url' => ['index']],
    ['label' => ($model->isNewRecord ? 'Новий запис' : 'Редагування')]
];
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                    <?= ($model->isNewRecord ? 'Новий запис' : 'Редагування') ?>
                </h3>
            </div>
        </div>
    </div>
...
$this->registerJs(<<<JS
$("#ourclients-upload").change(function() {
